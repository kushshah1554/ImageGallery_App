    ...
    <div className="min-h-screen bg-gradient-to-br  from-slate-900 via-slate-800 to-slate-900  flex items-center justify-center flex-col">
      ...
      <div className=" bg-white p-8 max-w-md rounded-2xl shadow-2xs w-full space-y-3">
        ...
        {/* <div className="space-y-3">
          <div>
            <button className="bg-white-500 text-gray-700 rounded-lg w-full py-3 font-semibold flex items-center justify-center gap-3 border-2 border-gray-200 hover:border-gray-300 transition-colors cursor-pointer">
          ...
          <div>
            <button className="bg-gray-900 text-white rounded-lg w-full py-3 font-semibold flex items-center justify-center gap-3 border-2  hover:bg-gray-800 transition-colors cursor-pointer">
